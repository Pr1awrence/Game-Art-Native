let games = [
    ...
    new Game("Diablo® III", "Action RPG from Blizzard Entertainment",
        ...
        ["RPG"], "../accets/all_games_catalog/diablo_III.jpg",
        19.99, 9.99, true),
    new Game("Destiny 2: Forsaken", "Action Shooter from Blizzard Entertainment",
        ...
        ["Shooter"], "../accets/all_games_catalog/destiny_2_forsaken.jpg",
        39.99, 29.99),
    ...
    new Game("The Elder Scrolls V: Skyrim", "Action RPG from Bethesda Game Studios",
        ...
        ["RPG"], "../accets/all_games_catalog/the_elder_scrolls_V_skyrim.jpg",
        39.99, 23.99),
    new Game("FINAL FANTASY XV ROYAL EDITION", "Role-playing from Square Enix",
        ...
        ["RPG"], "../accets/all_games_catalog/final_fantasy_XV_royal_edition.jpg",
        49.99, 29.99)
];
