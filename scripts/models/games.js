let games = [
    new Game("Dragon Age: Inquisition", "Action RPG from BioWare",
        ...
        "RPG", "../accets/all_games_catalog/dragon_age_inquisition.jpg",
        null, 19.99, true),
    new Game("Fallout 76", "Action RPG from Bethesda Game Studios",
        ...
        "RPG", "../accets/all_games_catalog/fallout_76.jpg",
        59.99, 40.19, true),
    new Game("Kingdom Come: Deliverance", "Action RPG from Warhorse Studios",
        ...
        "RPG", "../accets/all_games_catalog/kingdom_come_deliverance.jpg",
        59.99, 35.99, true),
    new Game("Minecraft", "Sandbox, survival from Mojang",
        ...
        "Sandbox, survival", "../accets/all_games_catalog/minecraft.jpg",
        null, 29.99, true),
    new Game("Grand Theft Auto V", "Action & Adventure from Rockstar Games",
        ...
        "Action & Adventure", "../accets/all_games_catalog/grand_theft_auto_V.jpg",
        29.99, 22.49),
    new Game("Diablo® III", "Action RPG from Blizzard Entertainment",
        ...
        "Action RPG", "../accets/all_games_catalog/diablo_III.jpg",
        19.99, 9.99, true),
    new Game("Destiny 2: Forsaken", "Action Shooter from Blizzard Entertainment",
        ...
        "Action Shooter", "../accets/all_games_catalog/destiny_2_forsaken.jpg",
        39.99, 29.99),
    new Game("South Park: The Fractured But Whole", "Role-playing from Ubisoft",
        ...
        "Role-playing", "../accets/all_games_catalog/south_park_the_fractured_but_whole.jpg",
        null, 59.99),
    new Game("Assassin's Creed® Origins", "Action & Adventure from Ubisoft",
        ...
        "Action & Adventure", "../accets/all_games_catalog/assassin's_creed_origins.jpg",
        59.99, 24.00, true),
    new Game("No Man's Sky", "Action & Adventure from Hello Games",
        ...
        "Action & Adventure", "../accets/all_games_catalog/no_man's_sky.jpg",
        49.99, 44.99),
    new Game("The Elder Scrolls V: Skyrim", "Action RPG from Bethesda Game Studios",
        ...
        "Action RPG", "../accets/all_games_catalog/the_elder_scrolls_V_skyrim.jpg",
        39.99, 23.99),
    new Game("FINAL FANTASY XV ROYAL EDITION", "Role-playing from Square Enix",
        ...
        "Action RPG", "../accets/all_games_catalog/final_fantasy_XV_royal_edition.jpg",
        49.99, 29.99)
];
...
//возможно стоит переместить эту функцию в ордер
Game.prototype.addToCard = function () {
    ...
    //эта функция не должна перенаправлять в корзину!
};

Game.prototype.buy = function () {
    Visualizer.renderOrdersPage(this);
    showAnotherBody("card_body");//открывает страницу с заказом
};
